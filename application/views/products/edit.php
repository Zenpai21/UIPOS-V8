          ...
          <form role="form" action="<?php base_url('users/update') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text"disabled class="form-control" id="qty" name="qty" placeholder="Enter Qty" value="<?php echo $product_data['qty']; ?>" autocomplete="off" />
                </div>
              ...
              <div class="col-md-6">
                <div class="form-group" style="text-align:center">
                  <img src="<?php echo base_url() . $product_data['image'] ?>" width="200" height="200" ><br>
