	...
	public function fetchProductData()
	{
		...
		foreach ($data as $key => $value) {
            ...
            if(in_array('updateProduct', $this->permission)) {
    			  $buttons .= '<a href="'.base_url('products/update/'.$value['id']).'" class="btn btn-warning" style="margin-right:3px;"><i class="fa fa-cubes"></i></a>';
            }

            if(in_array('updateProduct', $this->permission)) {
    			  $buttons .= '<a href="'.base_url('products/update/'.$value['id']).'" class="btn btn-primary"><i class="fa fa-pencil"></i></a>';
            }
