...
class Orders extends Admin_Controller
{
	...
	public function fetchOrdersData()
	{
		...
		foreach ($data as $key => $value) {
			...
			if(in_array('viewOrder', $this->permission)) {
				$buttons .= '<a target="__blank" href="'.base_url('orders/printDiv/'.$value['id']).'" class="btn btn-info"><i class="fa fa-print"></i></a>';
			}

			if(in_array('updateOrder', $this->permission)) {
				$buttons .= ' <a href="'.base_url('orders/update/'.$value['id']).'" class="btn btn-primary"><i class="fa fa-pencil"></i></a>';
			}
	...
	// fetch data and returns in json file
...
// get the data from row of products and returns in json file
